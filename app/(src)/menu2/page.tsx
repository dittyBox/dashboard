...
import * as t2 from '@/app/api/fech/verticalGroupBarTest';
import VerticalGroupBar from '@/app/api/component/chart/verticalGroupBar';

const stackedBarDataSet: stackedBarDataSet[] = t1.getStackedBarDataSet;
const verticalGroupBarDataSet: verticalGroupBarDataSet[] = t2.getverticalGroupBarDataSet;
...
const verticalGroupBarColumnConf: verticalGroupBarColumnConf[] = [
  {sort: 3, id: "t4", name: "폐기", color: "#2f7593"},
  {sort: 0, id: "t1", name: "정상", color: "#7cd865"},
  {sort: 1, id: "t2", name: "과다", color: "#4477dd"},
  {sort: 2, id: "t3", name: "문제", color: "#ea8c2e"},
...
const verticalGroupBarMargin: verticalGroupBarMargin = {
  top: 10,
  right: 10,
  bottom: 10,
  left: 35,
...
const verticalGroupBarConfig: verticalGroupBarConfig = {
  width: 600,
  height: 400,
...
const verticalGroupBarProps: verticalGroupBarProps = {
  elementID: "verticalGroupBar",
      ...
      <Grid xs={12} sx={{ backgroundColor: "rgba(225, 211, 55, 0)" }}>
        <Box sx={{ border: '1px solid grey', padding: "5px" }}>
          <Grid container direction={"row"} minHeight="350px" spacing={1}>
            ...
            <Grid xs={4} minWidth={'600px'} maxWidth={'600px'} display="flex" justifyContent="center" alignItems="center" >
              <VerticalGroupBar verticalGroupBarProps={verticalGroupBarProps} />
            </Grid>
            <Grid xs={2} maxWidth={'180px'} display="flex" justifyContent="center" alignItems="center" >
